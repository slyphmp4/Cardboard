...
public final class RegistryEventTypeProviderImpl implements RegistryEventTypeProvider {
    ...
    @Override
    public <T, B extends RegistryBuilder<T>> LifecycleEventType.Prioritizable<BootstrapContext, RegistryComposeEvent<T, B>> registryCompose(RegistryEventProvider<T, B> type) {
